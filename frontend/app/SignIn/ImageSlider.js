...
const images = [
  {
    ...
    description: "Explore high-performance desktops for work.",
  },
  {
    src: "/keyboard.jpg",
    alt: "Keyboard",
    title: "Mechanical Keyboards",
    description: "Experience smooth and fast typing with our keyboards.",
  },
  {
    src: "/printer.jpg",
    alt: "Printer",
    title: "Smart Printers",
    description: "Reliable and high-quality printing for every need.",
  },
  {
    src: "/lap.jpg",
    alt: "Laptop",
    title: "Modern Laptops",
    description: "Sleek, fast, and lightweight laptops for professionals.",
  },
  {
    src: "/c-class.jpg",
    alt: "C-Class Items",
    title: "Essential Accessories",
    description: "Affordable IT accessories for everyday use.",
  },
  {
    src: "/Server.jpg",
    alt: "Server",
    title: "Powerful Server Solutions",
    description: "High-performance servers designed for seamless data processing, reliability, and scalability for modern businesses.",
  },
];
