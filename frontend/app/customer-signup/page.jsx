...
const CustomerSignup = () => {
  ...
  const { otpMessage, otpSent, loading, handleOtpRequest } = useOtp();
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { isValid, errors: validationErrors } = validateForm(formValues, false);
  ...
  return (
    <div>
      <FormHeader
        title="Customer-Admin-Onboarding"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <ContactDetailsSection
                ...
                handleInputChange={handleInputChange}
                errors={errors}
                handleOtpRequest={() => handleOtpRequest(formValues.email, "customer")}
                loading={loading}
