...
const ProductCard = ({ product }) => {
  ...
  return (
    <div 
      className="bg-slate-100 border p-4 rounded-lg shadow-md flex flex-col h-[330px] w-full transition transform hover:scale-105 hover:z-10 bg-slate-80" // ✅ Increased height
    >
