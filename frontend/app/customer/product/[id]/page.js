...
const ProductDetail = () => {
  ...
  return (
    <>
      ...
      <ToastContainer />
      <div className=" w-full h-full mx-auto p-6 pt-24 bg-gray-50 min-h-screen">
        <div className="flex flex-col md:flex-row items-start border border-gray-300 rounded-lg p-6 shadow-md min-h-[400px] mt-6 mb-6">
