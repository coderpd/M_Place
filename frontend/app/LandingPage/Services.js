...
const Services = () => {
  return (
    <section
      className="bg-gradient-to-b from-gray-100 to-gray-200 py-20 px-6 md:px-12 font-[Inter]"
      id="services"
    >
      {/* Section Header */}
      <div className="text-center mb-14">
        ...
        <p className="text-lg text-gray-700 max-w-3xl mx-auto tracking-tight">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {servicesData.map((service, index) => (
          ...
          >
            <h3 className="text-2xl font-semibold text-indigo-700 mb-4 tracking-tight">
              {service.title}
            </h3>
            <p className="text-gray-700 tracking-tight">{service.description}</p>
          </div>
        ))}
      </div>
